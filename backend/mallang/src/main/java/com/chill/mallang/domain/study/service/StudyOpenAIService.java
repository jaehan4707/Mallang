    ...
    public JSONObject makeNewStudyQuiz(String word, String meaning) {
        String prompt = String.format(
                "역할: 문해력 문제 출제자\n" +
                        ...
                        "예시는 주어지지만 형식만 참조하고 question과 options는 계속 달라져야 함\n" +
                        "정답이 될 단어는 \"%s\"가 basic_type 이고 meaning은 \"%s\" 임 \n" +
                        "\n" +
                        "'question'\n" +
                        ...
                        "4. 각 option의 'idx' 키는 순서와 상관없이 무작위로 1-4까지의 숫자가 하나씩 추가됨.\n" +
                        "5. '오답 단어'는 정답 단어와 품사와 같으며, 문장에의 역할이 같지만 의미하는 바가 완전히 다른 단어.\n" +
                        "6. '오답 단어'는 정답 단어의 유의어나 동음이의어일 수 없음.\n" +
                        "7. 오답단어를 정답자리에 넣은 question문장이 자연스러운 문장이 된다면, 그 단어는 오답 단어로 적절하지 않으므로 제외하고 다시 생성함\n" +
                        "\n" +
                        "'word'\n" +
