...
public class QuizController {
    ...
    @PostMapping("/submit")
    public ResponseEntity<?> postQuizAnswer(@RequestBody @Valid QuizAnswerRequest requestQuizAnswer) {
    ...
    @PostMapping("/result")
    public ResponseEntity<?> getQuizResult(@RequestBody @Valid QuizResultRequest requestQuizResult) {
