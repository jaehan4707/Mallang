...
private val galmuri11Headline2 =
    TextStyle(
        fontFamily = galmuri11Family,
        fontWeight = FontWeight.SemiBold,
        fontSize = 24.sp,
...
private val omyuPrettyHeadline1 =
    TextStyle(
        fontFamily = omuyPrettyFamily,
        fontWeight = FontWeight.SemiBold,
        fontSize = 28.sp,
...
private val omyuPrettyHeadline2 =
    TextStyle(
        fontFamily = omuyPrettyFamily,
        fontWeight = FontWeight.SemiBold,
        fontSize = 24.sp,
...
private val omyuPrettyHeadline3 =
    TextStyle(
        fontFamily = omuyPrettyFamily,
        fontWeight = FontWeight.SemiBold,
        fontSize = 20.sp,
